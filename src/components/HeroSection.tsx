...
const HeroSection: React.FC = () => {
  ...
  return (
    <section
      id="about"
      className="relative min-h-screen bg-background text-foreground overflow-hidden px-6 pt-32 md:pt-36 pb-12 flex items-center scroll-mt-24"
    >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              ...
              <p className="text-base md:text-lg text-foreground/80 leading-relaxed">
                I'm a pre-final year B.Tech student in Data Science & Artificial
                Intelligence at IIIT Dharwad, passionate about building
                intelligent systems that merge machine learning, full-stack
                engineering, and real-time applications.
              </p>

              <p className="text-sm md:text-base text-muted-foreground">
                My interests span AI systems, LLMs, agentic workflows, real-time
                inference, and full-stack product development.
              </p>
            </div>
          </div>
